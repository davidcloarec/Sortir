 ...
 */
final class Version20230629193545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, venue_id INT DEFAULT NULL, organizer_id INT DEFAULT NULL, state_id INT NOT NULL, name VARCHAR(255) NOT NULL, starting_time DATETIME NOT NULL, duration INT NOT NULL, max_sign_up INT DEFAULT NULL, sign_up_limit DATETIME NOT NULL, info VARCHAR(255) DEFAULT NULL, cancel_motive VARCHAR(255) DEFAULT NULL, INDEX IDX_AC74095AAF5D55E1 (campus_id), INDEX IDX_AC74095A40A73EBA (venue_id), INDEX IDX_AC74095A876C4DDA (organizer_id), INDEX IDX_AC74095A5D83CC1 (state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, participant_id INT DEFAULT NULL, image_file VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C53D045F9D1C3019 (participant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, user_id INT NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, `admin` TINYINT(1) NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_D79F6B11AF5D55E1 (campus_id), UNIQUE INDEX UNIQ_D79F6B11A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP FOREIGN KEY FK_C53D045F9D1C3019');
